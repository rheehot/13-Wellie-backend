...
class MyBookView(View) :
    ...
    def delete(self, request) :
        try :
            ...
            my_books = Library.objects.filter(user_id=user_id, book_id__in=booklist)
            my_books.delete()
...
class ShelfDetailView(View) :
    ...
    def patch(self, request) :
        try :
            ...
            shelf_book = ShelfToBook.objects.filter(shelf_id = shelf_id ).exclude(book_id__in = booklist )
            shelf_book.delete()
